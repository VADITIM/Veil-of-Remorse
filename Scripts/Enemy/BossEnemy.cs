...
public class BossEnemy : EnemyBase
{
    ...
    private void SetupHealthBar()
    {
        ...
        {
            Debug.LogWarning("BossEnemy: No healthBarPrefab assigned!");
            return;
        }
        ...
        {
            Debug.LogWarning("BossEnemy: Slider component not found on health bar prefab!");
            return;
        }
    ...
    private void RegenerateHealth()
    {
        ...
        Debug.Log("BossEnemy: Regenerated health once.");
    }
